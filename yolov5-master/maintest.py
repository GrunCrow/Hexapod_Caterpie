...
def test():
    for url_img in os.listdir('C:/Users/usuario/Documents/GitHub/Hexapod_Caterpie/Dataset/imagenes'):
        print(url_img)
        os.system(f'python detect.py --weights ./runs/train/exp8/weights/best.pt --source {f"C:/Users/usuario/Documents/GitHub/Hexapod_Caterpie/Dataset/imagenes{url_img}"} --data data.yaml --exist-ok --save-txt')
