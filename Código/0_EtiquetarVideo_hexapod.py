...
HEXAPOD_NAME = CLASSES[0]

# Definimos la ruta del vídeo
VIDEO_NAME = "Hexapod.mp4"
VIDEO_PATH = DATASET_PATH + HEXAPOD_NAME + "/" + VIDEO_NAME

# Definimos el nombre del archivo CSV donde se guardarán las etiquetas
CSV_PATH = DATASET_PATH + "/CSVs/" + HEXAPOD_NAME + ".csv"
