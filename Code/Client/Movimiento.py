...
if __name__ == "__main__":
    ...
    while not stop:
        ...
        if F_Girado:
            ...
            if valor_distancia_izquierda == 0 and valor_distancia_derecha == 0 and valor_distancia == 0:
                girar = True
        ...
        if valor_distancia == 0 and not F_Girado:
            girar = True

        if valor_distancia >= umbral_de_distancia and not F_Girado: girar = True
